#include <QTimer>
#include <QKeyEvent>
#include "widget/FilterLineEdit.h"


FilterLineEdit::FilterLineEdit(QWidget* parent,QList<FilterLineEdit*>* filters,int columnnum): 
QLineEdit(parent),filterList(filters),columnNumber(columnnum)
{
    ...
    delaySignalTimer->setInterval(200);//Settings::getValue("databrowser", "filter_delay").toInt());  // This is the milliseconds of not-typing we want to wait before triggering
