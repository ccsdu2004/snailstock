...
struct VarMeta_log : public VarMeta
{
	...
	bool execute(int pos,ResultType& output)
	{
		...
		output.double_ = std::log(ret1.double_);
		return true;
	}
	static ObjectRegister<VarMeta,VarMeta_log,QString> dummy;
};

ObjectRegister<VarMeta,VarMeta_log,QString> VarMeta_log::dummy("log");
