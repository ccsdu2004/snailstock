...
struct VarMeta_floor : public VarMeta
{
	...
	bool execute(int pos,ResultType& output)
	{
		...
		output.double_ = std::floor(ret1.double_);
		return true;
	}
	static ObjectRegister<VarMeta,VarMeta_floor,QString> dummy;
};

ObjectRegister<VarMeta,VarMeta_floor,QString> VarMeta_floor::dummy("floor");
