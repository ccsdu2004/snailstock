...
struct VarMeta_plus : public VarMeta
{
	...
	static ObjectRegister<VarMeta,VarMeta_plus,QString> dummy;
};

ObjectRegister<VarMeta,VarMeta_plus,QString> VarMeta_plus::dummy("plus");
