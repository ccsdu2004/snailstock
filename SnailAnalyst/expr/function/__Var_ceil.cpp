...
struct VarMeta_ceil : public VarMeta
{
	...
	bool execute(int pos,ResultType& output)
	{
		...
		output.double_ = std::ceil(ret1.double_);
		return true;
	}
	static ObjectRegister<VarMeta,VarMeta_ceil,QString> dummy;
};

ObjectRegister<VarMeta,VarMeta_ceil,QString> VarMeta_ceil::dummy("ceil");
