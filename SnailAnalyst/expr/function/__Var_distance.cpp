...
struct VarMeta_distance : public VarMeta
{
	...
	bool execute(int pos,ResultType& output)
	{
		...
		output.double_ = GET_INCREASE(ret1.double_,ret2.double_);
		return true;
	}
	static ObjectRegister<VarMeta,VarMeta_distance,QString> dummy;
};

ObjectRegister<VarMeta,VarMeta_distance,QString> VarMeta_distance::dummy("distance");
