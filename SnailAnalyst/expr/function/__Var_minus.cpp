...
struct VarMeta_minus : public VarMeta
{
	...
	static ObjectRegister<VarMeta,VarMeta_minus,QString> dummy;
};

ObjectRegister<VarMeta,VarMeta_minus,QString> VarMeta_minus::dummy("minus");
