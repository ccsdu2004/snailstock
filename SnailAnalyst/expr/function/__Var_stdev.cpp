...
struct VarMeta_stddev : public VarMeta
{
	...
	bool execute(int pos,ResultType& output)
	{
		...
		output.double_ = gsl_stdev(d.data(),d.size());
		return true;
	}

	int n;
	static ObjectRegister<VarMeta,VarMeta_stddev,QString> dummy;
};

ObjectRegister<VarMeta,VarMeta_stddev,QString> VarMeta_stddev::dummy("stdev");
